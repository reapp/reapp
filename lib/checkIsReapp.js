...
function upgadeMessage(user, cur) {
  console.log("Steps to upgrade:\n".bold.yellow);
  console.log('  - In package.json set "reapp" set to ' + MAJOR_VERSION);
  console.log('  - Read upgrade instructions:');
  console.log('      https://github.com/reapp/reapp/blob/master/UPGRADE.md'.white.bold, "\n");
}